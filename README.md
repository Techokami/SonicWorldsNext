...
This uses [Godot 4.3](https://godotengine.org/) to implement a 2D Sonic the Hedgehog-like framework, intended for use in creating fangame projects and original game projects. Like Godot, the code within this repository is provided under the MIT License.
 if you use godot 3 use the [Godot 3 Branch here](https://github.com/Techokami/SonicWorldsNext/tree/Sonic-Worlds-Next-Godot-3), but please be aware that it isn't actively developed.
...
Please note that **we do NOT allow the use of generative AI in this project, period.** If you try to submit such material to this project, it will be denied, and repeated offenses will result in a ban. *This is non-negotiable!*
