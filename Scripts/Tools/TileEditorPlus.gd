...
#@export_enum("None", "Tilemap", "Custom") var template = 0
...
#@export_enum("no template", "Default template") var set = 0
#
## stamps
...
#
#	# press left mouse
#	if (Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT) and !lmbPress):
#		lmbPress = true
#
...
#	if (Input.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT) and !rmbPress):
